...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "cooltura.sqlite";
    public SQLiteDatabase sqLiteDatabase;
    private static final String TAG = "BDHelper";
    String tableName = "culturalplaces";
    ...
    public List<Place> getListOfPlaces(List<Place> placeList) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                place.category = cursor.getString(1);
                place.name = cursor.getString(2);
                place.address = cursor.getString(3);
                place.district = cursor.getString(4);
                place.longitude = cursor.getFloat(10);
                place.latitude = cursor.getFloat(11);
